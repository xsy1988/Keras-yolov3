...
# os.chdir('/Users/weilaixsy/python/yolo_v3')
# for file in os.listdir(os.getcwd()):
#     print (file)
# sys.path.append('/Users/weilaixsy/python/yolo_v3')
# import sys
...
# %%
def _main(config_path, weights_path, output_path, weights_only=True, plot_model=True):
...
if __name__ == '__main__':
    ...
    _main(config_path=config_path, weights_path=weights_path, output_path=output_path)